...
class Test(Formatting, ErrorHandling):
    ...
    def __setConnectionLoc(self, dataString, EastWestIP):
        """
        Sets the connection location of the object, based on what is in the string, and
         the IPs to look for
        ARGS:
            dataString      A String of data to look for IPs in
            EastWestIP      Tuple of Strings, the IP addresses of the East and West server
        """
